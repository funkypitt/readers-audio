package com.freedomfighter.readersaudio.whisper
...
/** A model loaded once and used for every piece of a long file. Not thread-safe: one piece at a time. */
class WhisperSession(model: File) : AutoCloseable {
    ...
    fun run(pcm16k: FloatArray, language: String?, onProgress: (Int) -> Unit): List<Segment>? {

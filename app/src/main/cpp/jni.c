...
Java_com_freedomfighter_readersaudio_whisper_WhisperLib_fullTranscribe(JNIEnv *env, jclass cls, jlong ptr, jint threads, jstring language, jfloatArray audio) {
    (void) cls;
